...
const getPartitionsOnExpandingLine = (lineIndex: number, lines: Line[]) => {
...
const getIndexOfClosingSeparator = (lineIndex: number, lines: Line[]) => {
  const line = lines[lineIndex];
...
const getPartitionsOnCollapsingLine = (lineIndex: number, lines: Line[]) => {
...
// TODO: Reuse setLines: Dispatch<SetStateAction<Line[]>>
const toggleLineCollapse = (lineIndex: number, lines: Line[], setLines: Dispatch<SetStateAction<Line[]>>): void => {
